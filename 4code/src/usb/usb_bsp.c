...
void USB_OTG_BSP_Init(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  //balmer GPIO_PinAFConfig(GPIOA,GPIO_PinSource8,GPIO_AF_OTG1_FS) ;
  //balmer GPIO_PinAFConfig(GPIOA,GPIO_PinSource9,GPIO_AF_OTG1_FS) ;
